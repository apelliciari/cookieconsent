...
var cc =
{
    ...
    checkLanguage: function (obj){

        return 'it';

        // custom per ogni cliente
            ...
            // {
            //      for (var lingua in obj.strings) {
            //         if (window.location.href.indexOf(lingua) >-1)
            ...
            // else{
            //      for (var lingua in obj.strings) {
            //         if (pathArray[1] == lingua){
            //             return lingua;
            //             }
            //         else{
                      
            //             if (window.location.host.indexOf(lingua) >-1)
            //                 return lingua;
            //             }
            //         }
    ...
    initialise: function (obj) {
        ...
        if (obj.strings !== undefined) {
            //check url per decidere lingua
            var lingua = cc.checkLanguage(obj);
          
           
            for (var attrname in obj.strings[lingua]) {

                this.strings[attrname] = obj.strings[lingua][attrname];
